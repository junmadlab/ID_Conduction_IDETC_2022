...
#Note: here "top" is some 71x71 array representing a mass distribution that you can assign 
#Note: "volf" and "wid" correspond to the volume bound and the adiabatic region length (I used to refer to it as "width", hence "wid"), respectively
...
filename = "pofmm.txt"
parameters = {"acceptable_tol": tolerance, "maximum_iterations": 0,"file_print_level": 5, "output_file":filename}
