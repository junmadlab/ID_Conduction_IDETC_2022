...
uu = it_array[10] #run iteration (4 runs per image to generate trajectory)
...
if uu==0:
    ...
    results = np.load("c_v="+str(vol_f)+"_w="+str(wis)+"_"+str(gg)+".npy")
...
filename2 = "c_v="+str(vol_f)+"_w="+str(wis)+"_"+str(gg)+".npy"
...
if uu==4: #after the end of a set of runs for a given image
    ...
    print("Control Trajectories Progress: " + str(progress) + "%.")
